...
namespace Common.Entities
{
    ...
    public class DecisionOption : ICloneable<DecisionOption>, IEquatable<DecisionOption>
    {
        ...
        /// <summary>
        /// Creates new decision option with passed parameters 
        /// </summary>
        /// <param name="antecedent"></param>
        /// <param name="consequent"></param>
        /// <returns></returns>
        public static DecisionOption Create(DecisionOptionAntecedentPart[] antecedent, DecisionOptionConsequent consequent, bool isAction, bool isModifable, int requiredParticipants, bool autoGenerated = false)
        {
            DecisionOption decisionOption = new DecisionOption();

            decisionOption.Antecedent = antecedent;
            decisionOption.Consequent = consequent;
            decisionOption.IsAction = isAction;
            decisionOption.IsModifiable = isModifable;
            decisionOption.RequiredParticipants = requiredParticipants;
            decisionOption.AutoGenerated = autoGenerated;
